...
namespace XoSoKienThiet.PRESENT
{
    public partial class frmPhieuNhanVe : DevExpress.XtraEditors.XtraForm
    {
        ...
        List<CT_PHIEUNHANVE_VIEW> List_CT_PhieuNhanVe = null;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            if (_PHIEUDANGKYVE_BUS.IsYourCompany(_MaPhieuDangKy) == true)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (_MaPhieuNhanVe == "")
                    {
                        ...
                        foreach (var item in DataInGV)
                        {
                            if (gvBASE.GetRowCellValue(i, gvBASE.Columns["DaTra"]).ToString() == "True")
                            {
                                ...
                                TongVe += item.SoLuongNhan.Value;
                                TongTien += item.ThanhTien.Value;
                            }
                            i++;
                        }
                       // _PHIEUNHANVE_BUS.Update(_MaPhieuNhanVe, TongVe.ToString(), TongTien.ToString());
                    }
                    else
                    {
                        var DataInGV = (List<CT_PHIEUNHANVE_VIEW>)gvBASE.DataSource;
                    ...
                    txtTongSoTien.Text = phieunhanve.TongTien.ToString();
                    txtTongSoVe.Text = phieunhanve.TongSoVe.ToString();
                }
            }
            else
            {
        ...
        private void btnThemPhieu_Click(object sender, EventArgs e)
        {
            ...
            List_CT_PhieuNhanVe = new List<CT_PHIEUNHANVE_VIEW>();
            _MaPhieuNhanVe = "";
        }
